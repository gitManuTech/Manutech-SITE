...
<html lang="pt-BR">
	...
	<body onload="loadStudentInfo()">
		...
		<main class="main">
			<form id="del-acc-form" name="del-acc-form" action="../ServerSide/del-acc-server.php" method="POST">
				<div class="form-part">
					<label for="del-acc-btn" class="del-acc">Deletar Conta:</label>
					<button type="submit" id="del-acc-btn" name="del-acc-btn">Deletar</button>
				</div>
			</form>
			<form id="ch-cour-form" name="ch-cour-form" autocomplete="off" onsubmit="return updateStudentCourse()">
				<div class="form-part">
